namespace PortalDefender.AavegotchiKit
{
    ...
    public class GotchiData 
    {
        ...
        public short[] modifiedNumericTraits;
        public short[] withSetsNumericTraits;
        ...
        public int withSetsRarityScore;
        ...
        public GotchiData()
        {
            ...
            modifiedNumericTraits = new short[6];
            withSetsNumericTraits = new short[6];
